...
onready var MasterSlider = "HSplitContainer/MasterSlider"
onready var MusicSlider = "HSplitContainer/MusicSlider"
onready var SFXSlider = "HSplitContainer/SFXSlider"
